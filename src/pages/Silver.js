    ...
    <section id="wrapper">
      ...
      <div className="wrapper">
        <div className="inner">
          ...
          <p>
          Available worldwide, Gastro Silver combines the very best industry knowledge, manufacturing techniques and high quality to produce a truly outstanding product.
