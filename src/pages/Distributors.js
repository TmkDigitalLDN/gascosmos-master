...
const IndexPage = () => (
  <Layout fullMenu>
    <section id="wrapper">
      <header>
        <div className="inner">
          <h2>Distributorship Application
Cost-Effective High-Quality N2O Cream Chargers</h2>
      ...
      <div className="wrapper">
        <div className="inner">
          <h3 className="major">The Company</h3>
          <p>
          Wholesale Chargers Ltd. have recently launched Gastro Cream Chargers to B2B Trade Only agents to enable their business to become an area or worldwide wholesale and retail distributor.
...
With constant stock availability, we are committed to providing agents with the world’s leading and most Cost-Effective High-Quality N2O Cream Chargers, Whipped Cream Dispensers and CO2 Cartridges.
          ...
          <h3 className="major">The Products</h3>
          <p>
...
Gastro Whipped Cream Dispensers – 250ml, 500ml and 1000ml dispensers that can be sold worldwide. Gastro Dispensers are available in aluminium, stainless steel or plastic headed versions in multiple colours and are manufactured by Wholesale Chargers Ltd’s PRC factory.
          ...
          <h3 className="major">A Business on a Plate</h3>
          <p>
          We are looking to appoint selected Gastro Distributors on a state, county, city or country basis.
...
<h3 className="major">The Quality</h3>
          <p>
...
<h3 className="major">The Requirements</h3>
          <p>
...
You must be ambitious and able to handle high order numbers. Your company must also be willing to grow and able to send us your business growth plans, facilitated by the exclusive supply of Gastro products.
...
<h4 className="major">Products</h4>
<p>Gastro Silver 8g N2O Cream Chargers - 
Gastro CO2, N2 Chargers and cartridges - 
Gastro Whipped Cream Dispensers </p>
<h4 className="major">Product Uses</h4>
<p>
Professional Uses - 
Food & Beverage Soda Beer and Wine - 
Specialist Gases and Custom Fills - 
Medical Procedure Use - 
Life Saving Equipment - 
Sports and Leisure Industry
</p>
<p>Websites: You should read through and familiarise yourself with one of our wholesale websites; Alibaba (click here), where and the product specifications and details can also be found. This website will form part of the leads generation system we have in place for active distributors. Any recipient of our generated leads is expected to reply within 24 hours and provide feedback on the outcome and status of said leads/customers.
</p>
<p>
Legal: By applying to become a customer or distributor you hereby acknowledge that you have; read, accepted and agree to the Terms of Business, Terms of Use Policy and Charger and Whipper Safety as detailed below. (click titles to download). Furthermore, you accept full responsibility to ensure that your customers; read, accept and agree to adhere to the same. Terms of Business Terms of Use Policy Charger and Whipper Safety</p>
              <h4 className="major">
             Marketing Materials
</h4>
<p>
...
<p>
Gastro Distributor opportunities are available worldwide.
...
<p>
The RRP (Recommended Retail Price) demonstrates Gastro has the competitive price edge positioning in the market. Customers can pay and order from this RRP price list via an existing distributor.

Alternatively, apply to become a distributor.

When accepted you will be sent our substantially discounted distributor rates to enable you to and earn a gross profit
              </p>
